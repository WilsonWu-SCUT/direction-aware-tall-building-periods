#!/usr/bin/env python3
"""Run the period-prediction analysis except fold cross-validation."""
...
from analysis.period_prediction.regression import (  # noqa: E402
    CATEGORY_ORDER,
    CONSTRAINTS,
    FT,
    HIGH_INTENSITY,
...
DEFAULT_DATA = ROOT / "data" / "period_prediction" / "tall_building_periods.sqlite"
DEFAULT_OUTPUT = ROOT / "results" / "period_prediction"
...
def main() -> None:
    ...
    print(f"Completed period-prediction analysis using {len(observations):,} observations.")
