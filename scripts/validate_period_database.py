...
DEFAULT_CSV = ROOT / "data" / "period_prediction" / "tall_building_periods.csv"
DEFAULT_DATABASE = ROOT / "data" / "period_prediction" / "tall_building_periods.sqlite"
...
def validate_english_only(root: Path) -> None:
    violations: list[str] = []
    ignored_directories = {".git", ".venv", "venv", "__pycache__", "site-packages"}
